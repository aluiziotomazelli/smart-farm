...
static constexpr uint8_t TANK_HEIGHT_CM = 150;  ///< Total height of water tank
...
static constexpr uint16_t LEVEL_DELTA_MIN = 10; ///< Minimum level change to detect

static constexpr uint64_t TIMER_FILLING_US = 30ULL * 1000000ULL;       ///< Time to sleep when tank is filling (30 s)
